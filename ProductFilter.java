...
public class ProductFilter {
    ...
    public ProductFilter(Map<String, String> map) {
        ...
        if (map.containsKey("name_like") && !map.get("name_like").isEmpty()) {
            String nameLike = map.get("name_like");
            spec = spec.and(ProductSpecifications.titleLikeExpression(nameLike));
            filterDefinition.append("&name_like=").append(nameLike);
        }
    }
}
